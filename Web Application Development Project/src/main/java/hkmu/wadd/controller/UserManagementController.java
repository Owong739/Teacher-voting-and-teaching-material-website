...
public class UserManagementController {
    ...
    public String list(ModelMap model) {
        model.addAttribute("commentUsers", umService.getCommentUsers());
        return "listUser";
    }
    ...
    public ModelAndView create() {
        return new ModelAndView("addUser", "commentUser", new Form());
    }
    @PostMapping("/create")
    public String create(Form form) throws IOException {
        umService.createCommentUser(form.getUsername(),
